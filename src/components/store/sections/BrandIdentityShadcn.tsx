...
interface BrandIdentityShadcnProps {
  isCollapsed?: boolean
}

export default function BrandIdentityShadcn({ isCollapsed = false }: BrandIdentityShadcnProps) {
  ...
  // Paleta de colores exacta del monolítico (21 colores)
  const colorPalette = [
          ...
          <PopoverTrigger asChild>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                />
                <span className="font-medium">{brandColor.toUpperCase()}</span>
              </div>
                ...
                <div className="grid grid-cols-4 gap-2">
                  {colorPalette.map((color) => (
                    <button
                      ...
                      className={cn(
                        'w-full h-12 rounded-lg border-2 hover:border-gray-400 transition-all hover:scale-105',
