...
-- Create unique constraint that allows NULL usuario_id
ALTER TABLE producto_likes ADD CONSTRAINT unique_producto_like 
  UNIQUE (producto_id, usuario_id, ip_address) 
  WHERE usuario_id IS NOT NULL;

-- For anonymous users (usuario_id IS NULL), ensure uniqueness by IP
...
--
-- Table: tienda_configuracion_inicio
--
